    ...
    children: [
      {
        ...
        description: 'Erstellen, hochladen und verwalten',
        to: routes.youtubeShorts,
        icon: Scissors,
        keywords: 'youtube shorts upload',
      },
      {
        id: 'tiktok-shorts',
        label: 'TikTok Shorts Creator',
        description: 'Clips erstellen, prüfen und veröffentlichen',
