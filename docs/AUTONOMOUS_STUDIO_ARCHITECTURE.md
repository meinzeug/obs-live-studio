...
Seit 24. Juli 2026 gilt zusätzlich die
[menschenzentrierte KI-Charta](./HUMAN_CENTERED_AI_CHARTER.md) mit Vorrang vor älteren Autonomieformulierungen:
Technische Autonomie dient Menschen; Personalabbau, autonome Personalentscheidungen und die Abschaffung menschlicher
Letztverantwortung sind nicht zulässig.
