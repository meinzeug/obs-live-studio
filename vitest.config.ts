...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@ans/agent-orchestrator': resolve(__dirname, 'packages/agent-orchestrator/src/index.ts'),
      ...
      '@ans/database/ai-roundtable': resolve(__dirname, 'packages/database/src/ai-roundtable.ts'),
      '@ans/database/ai-usage': resolve(__dirname, 'packages/database/src/ai-usage.ts'),
      '@ans/database/editorial-desk': resolve(__dirname, 'packages/database/src/editorial-desk.ts'),
      ...
      '@ans/database/agent-orchestrator': resolve(__dirname, 'packages/database/src/agent-orchestrator.ts'),
      ...
      '@ans/media-engine/audio-upload': resolve(__dirname, 'packages/media-engine/src/audio-upload.ts'),
